...
list_of_subdirectories_size.sort()

space_need_to_get_rid_of = 30000000 -  (70000000 - list_of_subdirectories_size[-1])
#print(space_need_to_get_rid_of)

for possible_dir in list_of_subdirectories_size:
    if possible_dir >=space_need_to_get_rid_of:
        print(possible_dir)
        break
